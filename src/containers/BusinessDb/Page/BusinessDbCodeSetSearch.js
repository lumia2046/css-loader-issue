...
class BusinessDbCodeSetSearch extends Component {
  constructor() {
    super()
    this.state = {};
  }
      ...
      <div className={css.ZTYXKQTopDiv}>
        <div>
          <p className={css.ZTYXKQButtonPLeft}>
            ...
            <Button type="primary" style={{ borderRadius: 30 }} ><Link to={`/businessDb/CodeSetSearch`} onClick={() => { }}>代码集查看</Link></Button>
          </p>
        </div>
        <div style={{ paddingTop: 45 }}>
          <div className={css.echartsHead}><img src={ZTBCX_ICON} /><font>代码集查询</font></div>
...
export default connect(mapStateToProps)(BusinessDbCodeSetSearch)
